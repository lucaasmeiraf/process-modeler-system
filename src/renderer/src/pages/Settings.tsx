      ...
      <div className="relative z-10">
        ...
        {showAddModal && (
          <div className="fixed inset-0 bg-black/70 backdrop-blur-lg flex items-center justify-center z-50">
            <div className="bg-dark-900 p-6 rounded-2xl w-full max-w-md border border-white/10 shadow-[0_30px_80px_rgba(0,0,0,0.7)]">
              ...
              <form onSubmit={handleSaveAgent} className="space-y-4">
                ...
                <div className="flex justify-end gap-3 mt-6">
                  ...
                  <button
                    type="submit"
                    className="px-4 py-2 rounded-xl bg-gradient-to-r from-cyan-400 to-blue-500 text-white font-bold flex items-center gap-2 shadow-lg shadow-blue-900/40 hover:opacity-90"
                  >
                    <Save size={18} />
                    Save Agent
                  </button>
